...
const BlogsPage = () => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      description: "Gym workouts are fantastic, and hitting the gym to chase pumps under fluorescent lights is where gains happen. However, if you've been stuck at the gym all winter and spring, it's time to think about taking your training outdoors and breaking a sweat in the sunshine and fresh air. This workout isn't just about burning [&hellip;]",
      content: "Complete 4-week outdoor workout plan details..."
    },
    {
      id: 3,
      ...
      description: "Nick Walker is on a mission to win the 2025 Mr. Olympia, and in a recent Instagram post, 'The Mutant' demonstrated some intense triceps dips as he forges his path to Las Vegas. This big man says that this is one of his favorite muscle-building moves, so here's how to try it for yourself. 'Dips [&hellip;]",
      content: "Detailed guide on Nick Walker's tricep dip technique..."
    }
  ];
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="bg-gray-50 p-6 rounded-lg text-center">
                  ...
                  <p className="text-gray-600">
                    Full blog content would be displayed here with detailed information about {selectedBlog.title.toLowerCase()}.
                  </p>
                </div>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Expert articles and insights on fitness, nutrition, and wellness</p>
        </div>
        ...
        {/* Articles Count */}
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-gray-900">210 Articles Available</h2>
        </div>
